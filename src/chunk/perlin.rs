...
impl PerlinCoord {
    pub fn from_voxel_block_coord_with_offset(block_coord: LocalVoxelBlockCoord, chunk_coord: ChunkCoord, offset: f64) -> PerlinCoord {
        PerlinCoord([
...
impl PerlinCoord3d {
    pub fn from_voxel_block_coord_with_offset(block_coord: LocalVoxelBlockCoord, chunk_coord: ChunkCoord, offset: f64) -> PerlinCoord3d {
        PerlinCoord3d([
            (block_coord.x as f64  + offset) + (chunk_coord.x as f64 * CHUNK_SIZE as f64),
